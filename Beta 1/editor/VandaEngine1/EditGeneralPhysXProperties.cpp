...
void CEditGeneralPhysXProperties::OnEnChangeEditCharacterSpeed()
{
	...
	m_fCharacterSpeed = atof( m_strCharacterSpeed );
}
...
void CEditGeneralPhysXProperties::OnOK()
{
	...
	else
	{
		...
		g_physXProperties.m_fCharacterSpeed = atof( m_strCharacterSpeed );
...
BOOL CEditGeneralPhysXProperties::OnInitDialog()
{
	...
	m_strDefaultRestitution.Format( "%f", g_physXProperties.m_fDefaultRestitution);
	m_strDefaultStaticFriction.Format( "%f", g_physXProperties.m_fDefaultStaticFriction);
	m_strDefaultSkinWidth.Format( "%f", g_physXProperties.m_fDefaultSkinWidth);
	m_strDefaultDynamicFriction.Format( "%f", g_physXProperties.m_fDefaultDynamicFriction);
	m_strGroundHeight.Format("%f", g_physXProperties.m_fGroundHeight);
	m_strGravityX.Format( "%f", g_physXProperties.m_fGravityX);
	m_strGravityY.Format( "%f", g_physXProperties.m_fGravityY);
	m_strGravityZ.Format( "%f", g_physXProperties.m_fGravityZ);
	m_strCameraCharacterDistance.Format( "%f", g_physXProperties.m_fCameraCharacterDistance);
	m_strCapsuleRadius.Format( "%f", g_physXProperties.m_fCapsuleRadius);
	m_strCapsuleHeight.Format( "%f", g_physXProperties.m_fCapsuleHeight);
	m_strCharacterPower.Format( "%f", g_physXProperties.m_fCharacterPower);
	m_strCharacterSpeed.Format( "%f", g_physXProperties.m_fCharacterSpeed);
	m_strCharacterSlopeLimit.Format("%f", g_physXProperties.m_fCharacterSlopeLimit);
	m_strCharacterSkinWidth.Format("%f", g_physXProperties.m_fCharacterSkinWidth);
	m_strCharacterStepOffset.Format("%f", g_physXProperties.m_fCharacterStepOffset);
	m_strJumpPower.Format("%f", g_physXProperties.m_fJumpPower);
