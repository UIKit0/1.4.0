...
struct CPhysXProperties
{
	...
	CPhysXProperties()
	{
		...
		m_fGravityY = -9.8f;
		m_fGravityZ = 0.0f;
		m_fCameraCharacterDistance = 1.0f;
		m_fCapsuleRadius = 0.3f;
		m_fCapsuleHeight = 1.0f;
		m_fCharacterPower = 3.0f;
		m_fCharacterSpeed = 5.0f;
		m_fJumpPower = 35.0f;
...
public:
	...
	CBool OnMenuClickedInsertPrefab(CPrefab* prefab = NULL); //if prefab is not null, we are loading from vin file
